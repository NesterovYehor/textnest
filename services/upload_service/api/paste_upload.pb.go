...
type UploadPasteRequest struct {
	...
	ExpirationDate *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=expiration_date,json=expirationDate,proto3" json:"expiration_date,omitempty"` // Expiration date
	Data           []byte                 `protobuf:"bytes,4,opt,name=data,proto3" json:"data,omitempty"`                                           // Paste content as bytes
}
...
func (x *UploadPasteRequest) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *UploadPasteResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
type UploadUpdatesRequest struct {
	...
	ExpirationDate *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=expiration_date,json=expirationDate,proto3,oneof" json:"expiration_date,omitempty"` // Optional field for expiration update
	Content        []byte                 `protobuf:"bytes,4,opt,name=content,proto3,oneof" json:"content,omitempty"`                                     // Optional field for content update
}
...
func (x *UploadUpdatesRequest) GetExpirationDate() *timestamppb.Timestamp {
	if x != nil {
		return x.ExpirationDate
	}
	return nil
...
func (x *UploadUpdatesRequest) GetContent() []byte {
	if x != nil {
		return x.Content
	}
	return nil
...
type UploadUpdatesResponse struct {
	...
	Message string `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"` // Response message (e.g., "Update successful" or error details)
}
...
func (x *UploadUpdatesResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
type ExpirePasteResponse struct {
	...
	Message string `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"` // Response message (e.g., "Paste expired successfully" or error details)
}
...
var file_paste_upload_paste_upload_proto_rawDesc = []byte{
	...
	0x98, 0x01, 0x0a, 0x12, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x50, 0x61, 0x73, 0x74, 0x65, 0x52,
	...
	0x6f, 0x6e, 0x44, 0x61, 0x74, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x74, 0x0a, 0x13, 0x55, 0x70,
	0x6c, 0x6f, 0x61, 0x64, 0x50, 0x61, 0x73, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x43, 0x0a, 0x0f, 0x65,
	...
	0x22, 0xca, 0x01, 0x0a, 0x14, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x55, 0x70, 0x64, 0x61, 0x74,
	...
	0x65, 0x72, 0x49, 0x64, 0x12, 0x48, 0x0a, 0x0f, 0x65, 0x78, 0x70, 0x69, 0x72, 0x61, 0x74, 0x69,
	...
	,
...
var file_paste_upload_paste_upload_proto_depIdxs = []int32{
	...
	8, // 2: pasteupload.UploadUpdatesRequest.expiration_date:type_name -> google.protobuf.Timestamp
	0, // 3: pasteupload.PasteUpload.UploadPaste:input_type -> pasteupload.UploadPasteRequest
	2, // 4: pasteupload.PasteUpload.UploadUpdates:input_type -> pasteupload.UploadUpdatesRequest
	4, // 5: pasteupload.PasteUpload.ExpirePaste:input_type -> pasteupload.ExpirePasteRequest
	6, // 6: pasteupload.PasteUpload.ExpireAllPastesByUserID:input_type -> pasteupload.ExpireAllPastesByUserIDRequest
	1, // 7: pasteupload.PasteUpload.UploadPaste:output_type -> pasteupload.UploadPasteResponse
	3, // 8: pasteupload.PasteUpload.UploadUpdates:output_type -> pasteupload.UploadUpdatesResponse
	5, // 9: pasteupload.PasteUpload.ExpirePaste:output_type -> pasteupload.ExpirePasteResponse
	7, // 10: pasteupload.PasteUpload.ExpireAllPastesByUserID:output_type -> pasteupload.ExpireAllPastesByUserIDResponse
...
func file_paste_upload_paste_upload_proto_init() {
	...
	file_paste_upload_paste_upload_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
