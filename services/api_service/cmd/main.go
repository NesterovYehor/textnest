...
func main() {
	...
	mux.HandleFunc("/v1/users/activate/{id}", handler.ActivateUser(appContext))
	mux.Handle("POST /v1/tokens/password", middlewares.Authenticate(handler.ResetPassword(appContext)))
